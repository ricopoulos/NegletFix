...
**Last research audit**: 2026-06-12 — ruv-neural / ruvnet added as `GH-001`, an analysis-side GitHub watch lead for offline EEG topology/min-cut ideas only. NeurIPS 2025 EEG-AI methods lane remains `NP-001..NP-009` and tracks BrainBodyFM, the EEG Foundation Challenge, REVE, LUNA/BioFoundation, BrainOmni, NeurIPT, CSBrain, EEG-Bench, and the EEG-FM critical review as future signal-analysis leads only. 2026-06-11 clinical-trials watchlist remains the AV+tDCS / visual-rehab registry baseline; key status correction: NCT04963075 is completed with posted results; NCT05894434 is not yet recruiting; NCT06116760 is the completed exact AV+tDCS chronic HVFD trial linked to Diana 2025.
...
| [[research-papers-index]] | Every cited paper — full citation, DOI, key finding, NegletFix relevance; **2026-06-12**: NeurIPS 2025 EEG-AI methods lane and ruv-neural GitHub watch lead added as low direct-impact methods/source cluster | **2026-06-12** | HIGH (citations now verified) |
...
| Research Watchlist | operational | 🟢 green | `docs/research/source-queue-2026-05-25.csv` / `docs/research/clinical-trials-watchlist-2026-06-11.csv` / `docs/research/research-monitor-2026-06-11.html` / `[[clinical-trials-watchlist]]` | Source intake now includes YouTube, X, LinkedIn/arXiv, GitHub watch repos, NeurIPS/OpenReview, and ClinicalTrials.gov rows; no automation created yet |
