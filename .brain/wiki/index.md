...
**Last research audit**: 2026-08-13 — research monitor refreshed to 85 source rows and 35 ClinicalTrials.gov rows. The only true new-since-July registry row was `CTG-028` / `NCT07752563`, a Glasgow pilot RCT of NeuroEyeCoach/VISIOcoach computer-based eye-movement training after stroke. `PM-010` / `PMID42571232` was added as the DRIVE-study protocol paper linked to `CTG-015` / `NCT07147660`. Older but useful gap-fill rows `CTG-029..CTG-035` now cover BITS touchscreen field-awareness results, AP-HP Paris tACS, Fondation Rothschild blindsight/fMRI, INSERM VR audiovisual telerehab, Rochester home blind-field retraining, Toronto microperimetry biofeedback, and Schepens prism feasibility. Interpretation stays watch/comparator only; no change to Quest AV protocol.
...
| [[eeg-neurofeedback]] | Muse TP10 pipeline; **2026-05-14**: hemianopia-vs-neglect category mismatch flagged, Treves 2025 consumer-NF null result, Muse signal-quality downgrade; **2026-06-12**: NeurIPS 2025 EEG-AI methods lane and ruv-neural GitHub watch lead added as no-protocol-impact analysis leads | **2026-06-12** | MIXED ↓ |
...
| [[research-papers-index]] | Every cited paper — full citation, DOI, key finding, NegletFix relevance; **2026-08-13**: DRIVE-study protocol `PM-010`, Paris/French clinical context rows, and Neuro-JEPA v3 watch update added | **2026-08-13** | HIGH (citations now verified) |
| [[clinical-trials-watchlist]] | Live-tracked NCT registry watchlist for AV+tDCS, AV/multisensory, VRT, VR cross-modal, device/compensation, driving/function, neuromodulation trials, Mayo institutional rows, and Paris/French local context; source CSV in `docs/research/clinical-trials-watchlist-2026-08-13.csv`; static monitor in `docs/research/research-monitor-2026-08-13.html` | **2026-08-13** | HIGH for registry/institutional status / MIXED for protocol impact |
...
| Huang/Razavian et al. (2026) — Neuro-JEPA | arXiv:2606.14957 | MRI foundation-model / neuroimaging analytics watch lead |
| NeurIPS 2025 EEG-AI lane | NP-001..NP-009 | EEG foundation-model methods lane and guardrails |
| ruvnet / ruv-neural | GH-001 | Rust EEG topology analysis repo; offline inspiration only |
| Mayo Clinic institutional lane | INST-001..INST-004 | Trusted institutional watch source for neuro-ophthalmology, PM&R, trial surfaces, and stroke-vision posts |
...
| NCT06136169 / Toh, Xu, Baker & Bowers (2026) | PMID 42140549 | Reminder-cue/head-scan training; functional compensation and hazard-detection comparator |
| Bowers et al. (2026) — prism crossover trial | PMID 42274646 | Multi-periscopic vs Fresnel peripheral prism accommodation comparator |
| Choe/Baker/Bowers et al. (2026) naturalistic driving cluster | PMID 42102308 / PMID 41747510 | Function measurement and head-scan behavior context only |
...
| EEG Pipeline (code) | implemented | 🟡 yellow | `Unity/NeglectFix/Assets/Scripts/EEG/` | Code written + simulator path works; real Muse untested on Eric; LuMamba/BioFoundation and ruv-neural tracked as future offline signal-analysis leads only |
...
| Research Watchlist | operational | 🟢 green | `docs/research/source-queue-2026-05-25.csv` / `docs/research/clinical-trials-watchlist-2026-08-13.csv` / `docs/research/research-monitor-2026-08-13.html` / `docs/research/research-refresh-2026-08-13.md` / `[[clinical-trials-watchlist]]` | Source intake now includes 85 rows across YouTube, X, PubMed, LinkedIn/arXiv, GitHub watch repos, NeurIPS/OpenReview, Mayo institutional rows, AI-neuroimaging row `IMG-001`, local Paris lead `LI-002`, and 35 ClinicalTrials.gov rows; `CTG-028` and `PM-010` added 2026-08-13; no automation created yet |
