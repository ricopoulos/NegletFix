...
**Last research audit**: 2026-09-25 — 88 source rows, 36 ClinicalTrials.gov rows. `CTG-036` is a new French optokinetic reading study, not yet recruiting; `CTG-012` and `CTG-016` moved to completed with results posted. `PM-011` is a newly surfaced review and `PM-012` an eye-tracking measurement validation. HEMIANOTACS at Pitié-Salpêtrière remains completed with no posted results; the prior attribution of Raffin 2025 to that trial was removed. All new material remains comparison/watch context; no Quest protocol change. Sources: `docs/research/research-refresh-2026-09-25.md`, `docs/research/clinical-trials-watchlist-2026-09-25.csv`.
...
| [[research-papers-index]] | Every cited paper — full citation, DOI, key finding, NegletFix relevance; **2026-09-25**: review `PM-011`, measurement paper `PM-012`, and HEMIANOTACS/Raffin attribution correction | **2026-09-25** | HIGH (citations now verified) |
| [[clinical-trials-watchlist]] | 36-record NCT watchlist for AV, visual retraining, compensation, devices, neuromodulation and Paris/French context; source CSV in `docs/research/clinical-trials-watchlist-2026-09-25.csv`; static monitor in `docs/research/research-monitor-2026-09-25.html` | **2026-09-25** | HIGH for registry/institutional status / MIXED for protocol impact |
...
| Raffin et al. (2025) ★ | PMID 41243213 | cf-tACS V1↔MT in chronic hemianopia (n=16); not verified as HEMIANOTACS results |
...
| Research Watchlist | operational | 🟢 green | `docs/research/source-queue-2026-05-25.csv` / `docs/research/clinical-trials-watchlist-2026-09-25.csv` / `docs/research/research-monitor-2026-09-25.html` / `docs/research/research-refresh-2026-09-25.md` / `[[clinical-trials-watchlist]]` | Source intake includes 88 rows and 36 ClinicalTrials.gov rows; September added `CTG-036`, `PM-011..PM-012`, two completion status changes, and a Pitié/Raffin attribution correction; no protocol change or automation created |
