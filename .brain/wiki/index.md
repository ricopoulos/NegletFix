...
**Last research audit**: 2026-06-11 — clinical-trials watchlist and static HTML research monitor added for AV+tDCS, audiovisual/multisensory training, visual restoration, and neuromodulation leads. Key status correction: NCT04963075 is now completed with posted results; NCT05894434 is not yet recruiting; NCT06116760 is the completed exact AV+tDCS chronic HVFD trial linked to Diana 2025.
...
| Research Watchlist | operational | 🟢 green | `docs/research/clinical-trials-watchlist-2026-06-11.csv` / `docs/research/research-monitor-2026-06-11.html` / `[[clinical-trials-watchlist]]` | Clinical-trial tracking now data-backed with a static monitor; no automation created yet |
