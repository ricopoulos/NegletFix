...
**Last research audit**: 2026-06-12 — NeurIPS 2025 EEG-AI methods lane added to the source queue, static research monitor, EEG wiki, and research-papers index. It tracks BrainBodyFM, the EEG Foundation Challenge, REVE, LUNA/BioFoundation, BrainOmni, NeurIPT, CSBrain, EEG-Bench, and the EEG-FM critical review as future signal-analysis leads only. 2026-06-11 clinical-trials watchlist remains the AV+tDCS / visual-rehab registry baseline; key status correction: NCT04963075 is completed with posted results; NCT05894434 is not yet recruiting; NCT06116760 is the completed exact AV+tDCS chronic HVFD trial linked to Diana 2025.
...
| [[eeg-neurofeedback]] | Muse TP10 pipeline; **2026-05-14**: hemianopia-vs-neglect category mismatch flagged, Treves 2025 consumer-NF null result, Muse signal-quality downgrade; **2026-06-12**: NeurIPS 2025 EEG-AI methods lane added, with LuMamba/BioFoundation preserved as a no-protocol-impact watch lead | **2026-06-12** | MIXED ↓ |
...
| [[research-papers-index]] | Every cited paper — full citation, DOI, key finding, NegletFix relevance; **2026-06-12**: NeurIPS 2025 EEG-AI methods lane added as a low-medium direct-impact source cluster | **2026-06-12** | HIGH (citations now verified) |
...
| Research Watchlist | operational | 🟢 green | `docs/research/source-queue-2026-05-25.csv` / `docs/research/clinical-trials-watchlist-2026-06-11.csv` / `docs/research/research-monitor-2026-06-11.html` / `[[clinical-trials-watchlist]]` | Source intake now includes YouTube, X, LinkedIn/arXiv, NeurIPS/OpenReview, and ClinicalTrials.gov rows; no automation created yet |
